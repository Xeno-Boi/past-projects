...
void Display::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->updateDisplay((*reinterpret_cast< std::add_pointer_t<string>>(_a[1]))); break;
        case 1: _t->display((*reinterpret_cast< std::add_pointer_t<string>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Display::*)(string )>(_a, &Display::updateDisplay, 0))
            return;
    }
}
...
// SIGNAL 0
void Display::updateDisplay(string _t1)
{

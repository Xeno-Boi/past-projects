...
int FloorObject::createGeom(Shader shader) {
	Vertices vtx;
	Indices ind;
	...
	GLfloat vertex[] = {
		// Position				Color
		-1.0f,  0.0f,  1.0f,	1.0f, 0.0f, 0.0f, 1.0f,		// Top Left
		 1.0f,  0.0f,  1.0f,	0.0f, 1.0f, 0.0f, 1.0f,		// Top Right
		 1.0f,  0.0f, -1.0f,    0.0f, 0.0f, 1.0f, 1.0f,		// Bottom Right
...
int FloorObject::createVAO(Shader shader, Vertices vtx, Indices ind) {
...
int FloorObject::render(Shader shader)
{

...
public:
	...
	int copyFloatVectorToShader(float *v, int vectorSize, int numElementInts, const char* name);
	int copyIntVectorToShader(int* v, int vectorSize, int numElementFloats, const char* name);
